...
assemblyName = 'assembly20260514.mat'; %'assembly20250207.mat';  
for aa = 1:2
    switch aa
        case 1
    ...
    for yy = yidx
        ...
        for idata = thisdata
            ...
            load(saveName,'expval_tgt','corr_tgt','latencyStats','avgAmp_hm','p_hm','spkOk_th', ...
                ...
                'auc_hm', 'corr_tgt_avg','corr_tgt_avg_rel','saccDirNoTask_spkOkUCue');
            ...
            saccDirNoTask_spkOkUCue_pop{idata} = saccDirNoTask_spkOkUCue; %14/5/26

            clear mFiringRate
        end

        save(fullfile(saveFolder, assemblyName),...
            'id_pop','expval_tgt_pop','corr_tgt_pop','corr_tgt_rel_pop',...
