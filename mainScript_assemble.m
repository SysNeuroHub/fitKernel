        ...
        if exist(saveName, 'file')
            ...
            try
                ...
                if isfield(S,'kernelInfo')
                    ...
                    expval_tgt(1,1) = getExpVal_tgt(S.PSTH_f, S.predicted_all, eyeData.catEvTimes, S.t_r, tWin);
                    expval_tgt(2:nPredictorNames+1,1) = getExpVal_tgt(S.PSTH_f, S.predicted, eyeData.catEvTimes, S.t_r, tWin);
