...
load('/media/daisuke/cuesaccade_data/param20241111.mat');
...
for yy = 1:3
        ...
        if exist(saveName, 'file')
            ...
            try
                ...
                S = load(saveName, 'PSTH_f','predicted_all', 'predicted', ...
                    'kernelInfo','t_r','cellclassInfo','mFiringRate','t_cat','stats_stratifiedByCue'); %param
    ...
    save(fullfile(saveFolder, 'assembly20241111.mat'),'assembly','param');
    assembly = [];
end