...
for yyy = 1:3
    ...
    % thisdata = [find(1-cellfun(@isempty, regexp(loadNames, ...
    %     regexptranslate('wildcard',fullfile(rootFolder, year, 'cuesaccade_data','11November','30','*_ch6')))))]; %2022 vision
    ...
    for idata = thisdata
        ...
        try
            ...
            %% stratified by cue
            [fig, stats_stratifiedByCue] = showTonsetResp_stratifiedByCue(PSTH_f, t_r, onsets_cat, catEvTimes, tWin_t,  ...
